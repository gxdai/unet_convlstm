...
import os
label_background = 255            # Set background label as 255. There are 5 meaningful classes. labeling 0, 1, 2, 3, 4
im_w = 512
im_h = 512


image_dir_name = 'Images'
label_dir_name = 'labelsAsImage'
        ...
        for index in range(5):
            ...
            for tmp in labellist:
                if label_check == tmp:
                    ...
                    #print(im_data.shape)
        labelfile = os.path.join(labeldir, slide[:-4] + '.png')             # The output file name
